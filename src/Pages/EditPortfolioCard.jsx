...
export default function EditPortfolioCard() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                //Set headers for axios with token
                ...
                const response = await axiosInstance.get(`http://localhost:3000/api/portfolio/${itemID}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // make and API call to backend portfolio update endpoint
            const response = await axiosInstance.patch(`http://localhost:3000/api/portfolio/${itemID}`, formData)
            // .then(response => {
            ...
            if (response.status === 200) {
                ...
                // Display success message to the user or redirect as needed
                navigate("/portfolio")
            } else {
                console.log("API call was successful, but response status was not 200");
                // Display an appropriate message to the user about the status code
            }
    ...
    return (
        <div>
            ...
            <div className="container m-5 border border-solid flex flex-col">
                <div>
                    <h2 className="text-xl font-semibold py-3">Update Investment</h2>
                </div>
                <div>
